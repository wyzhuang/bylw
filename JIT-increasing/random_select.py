    ...
    for test_project in test_projects:
        for i in range(10):
            ...
            for test_data in lst_test_data:
                ...
                if len(new_train_labels)-1>len(train_labels):
                    new_train_labels=new_train_labels[len(train_labels):len(new_train_labels)]
                    new_train_features=new_train_features[len(train_labels):len(new_train_features)]
