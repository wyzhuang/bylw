...
def train_and_predict(project):
    ...
    for test_project in test_projects:
        ...
        for i in range(10):
            ...
            np.save('../res/KK/{}_{}_{}.npy'.format(project, test_project, i), predict_y)
            ...
            with open('../res/KK/res.txt', 'a+', encoding='utf-8') as f:
                f.write('{}_{} {} {} {} {}\n'.format(
                    project + "_" + test_project,
                    str(i),
                    precision_score(y_true=test_labels, y_pred=predict_y),
...
if __name__=='__main__':
    ...
    processes = [Process(target=train_and_predict, args=(project,)) for project in projects]
