...
for metric in metrics:
    ...
    print(r" &\multicolumn{"+str(len(models))+"}{c|}{" + metric + r"}  &\multicolumn{"+str(len(models)-1)+r"}{c}{$p \vdots \delta$}   \\\hline")
    ...
    # print("task &RF &QRS2015 &ICSE2016 &IET2020 &GH-ACE &RF vs.GH-ACE &QRS2015 vs.GH-ACE &ICSE2016 vs.GH-ACE &IET2020 vs.GH-ACE \\\hline")
